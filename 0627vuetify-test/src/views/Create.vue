<template>
	...
	<v-form class="ma-5" ref="form" v-model="valid" lazy-validation>
		...
		></v-textarea>
		<v-text-field :rules="priceRules" prefix="$" v-model="product.price" label="Price" required></v-text-field>
		<v-text-field :rules="quantityRules" v-model="product.quantity" label="Quantity" required></v-text-field>
		<v-text-field :rules="imageRules" v-model="product.image" label="Image" required></v-text-field>
